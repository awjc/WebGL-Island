...
export class PopulationGraph {
    constructor() {
        // Data storage (keep up to 7200 seconds of history)
        this.maxStoredDataPoints = 7200; // Store up to 2 hours of data
    ...
    setTimeWindow(seconds) {
        this.displayDataPoints = Math.max(10, Math.min(7200, seconds)); // Clamp between 10 and 7200 seconds
